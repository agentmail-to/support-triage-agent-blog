...
const KNOWLEDGE_ARTICLES = {
  "export-data": {
    category: "how_to",
    reply:
      "You can request an account export from Settings > Data export > Request export. We will email the download link when the file is ready.",
  },
  "change-timezone": {
    category: "how_to",
    reply:
      "Open Settings > Preferences, choose your timezone, and save the change. New dates in the product will use that timezone.",
  },
